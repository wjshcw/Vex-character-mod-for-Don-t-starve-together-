...
return {
	...
	ANNOUNCE_BOAT_LEAK = "好耶,我们都得死",
	ANNOUNCE_BOAT_SINK = "等死吧",
    ...
    ANNOUNCE_RUINS_RESET = "从头再来",
    ANNOUNCE_SNARED = "好麻烦",
    ANNOUNCE_REPELLED = "你也不想别人靠近?",
	ANNOUNCE_ENTER_DARK = "这地方不赖",
	ANNOUNCE_ENTER_LIGHT = "呃,阳光",
	ANNOUNCE_FREEDOM = "然后呢?",
	ANNOUNCE_HIGHRESEARCH = "我什么时候知道的?",
	ANNOUNCE_HOUNDS = "黑影,准备把要来的东西处理掉",
	ANNOUNCE_WORMS = "黑影,准备把要来的东西处理掉",
	ANNOUNCE_HUNGRY = "饿了记得喂我,黑影",
	...
	DESCRIBE =
	{
		-- 本mod物品台词样例（后续照此格式补充，键 = prefab名全大写）
        VEX_MULTITOOL   = "我懒得带那么多工具，有意见吗？",
        VEX_MULTITOOL_2 = "省的我一个个砍。",
        VEX_MULTITOOL_3 = "干活好累……",

        VEX_GLOOM_WEAPON = "我们弄简单点，我在这等着，你自己去死。",
        VEX_SHADOW_STAFF = "我在峡谷里都不需要这个。",
        VEX_RUNE_STAFF   = "砰，然后所有人都死了。",

        VEX_SHADOW = "黑影你知道吗，有时候，我几乎都要不讨厌你了。",

        VEX_SKILL_UPGRADE_1 = "这不是班德尔城花名册，这是我讨厌的约德尔人的名单。",
        VEX_SKILL_UPGRADE_2 = "里面收录了暗影岛最黑暗沉重的故事。",
        VEX_SKILL_UPGRADE_3 = "？这本为什么是冕卫家族传记？",
        VEX_SKILL_UPGRADE_4 = "老实说我不知道这本讲了什么，我懒得看。",

        VEX_UPGRADE_SPEED_1 = "天呐走路最烦了。",
        VEX_UPGRADE_SPEED_2 = "行了行了，在路上了。",
        VEX_UPGRADE_SPEED_3 = "我们要去哪？呃，话说回来，其实无所谓。",
        VEX_UPGRADE_SPEED_4 = "啊黑影，来背我吧。",

        VEX_UPGRADE_GLOOM_1 = "拜托，请放我回到悲伤里吧",
        VEX_UPGRADE_GLOOM_2 = "既然我不开兴，大家也都别好过",
        VEX_UPGRADE_GLOOM_3 = "伤心的来啦",
        VEX_UPGRADE_GLOOM_4 = "和我感同身受吧",

        VEX_UPGRADE_PRESERVE_1 = "随便吧。",
        VEX_UPGRADE_PRESERVE_2 = "冰不冰无所谓。",
        VEX_UPGRADE_PRESERVE_3 = "冰冷的黑暗……用来保鲜？无趣。",
        VEX_UPGRADE_PRESERVE_4 = "又少了件要处理的事。",

        VEX_UPGRADE_SURVIVAL_1 = "黑影，帮我挡住阳光。",
        VEX_UPGRADE_SURVIVAL_2 = "哪里有彩虹，哪里就有风雨。",
        VEX_UPGRADE_SURVIVAL_3 = "活着好累啊。",
        VEX_UPGRADE_SURVIVAL_4 = "黑影，帮我把温度调到30°C。",
        
        VEX_UPGRADE_DEFENSE_1 = "离我，远点。",
        VEX_UPGRADE_DEFENSE_2 = "别跟我说话。",
        VEX_UPGRADE_DEFENSE_3 = "你靠得太近了。",
        VEX_UPGRADE_DEFENSE_4 = "感觉好多了。",

        VEX_STORAGE_1 = "黑影，干活了。",
        VEX_STORAGE_2 = "我懒得拿那么多。",
        VEX_STORAGE_3 = "屯这么多东西干什么。",
        VEX_STORAGE_4 = "丢进去，再见，再也不见。",

        VEX_HAT_CAMOUFLAGE = "我只希望这兜帽能把我的脸全挡上。",
        VEX_HAT_CONCEAL    = "说真的，难得有一段时间可以独处。",
        VEX_HAT_INVISIBLE  = "这是个什么，我怎么看不见？",
